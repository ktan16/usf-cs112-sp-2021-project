...
public class Graph extends JPanel {
	...
	private static KNNPredictor kP;
...
//        this.data = data;
        ...
        this.data = kP.readData("titanic.csv");
...
//                g2.setColor(red);
//            }
            String label = kP.test(data.get(i));
    ...
    private static void createAndShowGui(int K, String fileName) {
		...
		System.out.println("Accuracy:" + (kP.getAccuracy(mainPanel.data)));
		System.out.println("Precision:" + (kP.getPrecision(mainPanel.data)));

		JLabel accuracy = new JLabel("Accuracy: " + kP.getAccuracy(mainPanel.data));
		JLabel precision = new JLabel("Precision: " + kP.getPrecision(mainPanel.data));
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
            	...
            	if (scanner.hasNextInt()) {
            		...
            		if (inputK%2 != 0) {
            			createAndShowGui(inputK, fileName);
            		} else {
